    ...
    methods: {
      getData() {
        ...
        const config = {
          ...
          title: '',
          barPadding: 0.15,
          margins: {top: 40, left: 40, bottom: 30, right: 30},
        ...
        const myGroups = Array.from(new Set(dataOrigin.map(d => d.group)));
        const myVars = Array.from(new Set(dataOrigin.map(d => d.variable)));
        /* ----------------------------尺度转换------------------------  */
        ...
        chart.renderBars = function () {
          ...
          groups.join("rect")
              .attr("x", function(d) { return chart.scaleX(d.group) })
              .attr("y", function(d) { return chart.scaleY(d.variable) })
              .attr("rx", 4)
              .attr("ry", 4)
              .classed('heatmap',true)
              .attr('stroke', 'none')
              .attr("width", chart.scaleX.bandwidth() )
              .attr("height", chart.scaleY.bandwidth() )
